...
const correctAnswer = "Escasos caballitos"; // Respuesta correcta
...
function checkAnswer() {
    if (selectedButton) {
        ...
        if (selectedAnswer === correctAnswer) {
            ...
            alert("¡Incorrecto! Esa no es la cantidad de caballitos");
        }
    } else {
...
document.getElementById('next').addEventListener('click', () => {
    window.location.href = 'carrucel3.html'; // Cambia 'paginaSiguiente.html' por la URL deseada
});

document.getElementById('retry').addEventListener('click', () => {
    window.location.href = 'Carrucel2.html'; // Cambia 'paginaReintentar.html' por la URL deseada
});
