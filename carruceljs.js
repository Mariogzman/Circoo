...
const correctAnswer = "Bastantes caballitos"; // Respuesta correcta
...
function retryQuestion() {
    ...
    selectedButton = null;
    document.querySelectorAll('.answer-button').forEach(button => button.classList.remove('selected'));
    window.location.href = 'Carrucel1.html'; // Reemplaza con la URL deseada
}
...
document.getElementById('retry').addEventListener('click', () => {
    window.location.href = 'Carrucel1.html'; // Cambia ' por la URL deseada
});
