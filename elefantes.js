...
function checkAnswer() {
    ...
    if (elefantesEnCuadro === 4) {
        alert("¡Correcto! Has colocado 4 elefantes en el cuadro.");
    } else {
...
document.getElementById('next').addEventListener('click', () => {
    window.location.href = 'elefantes2.html'; // Cambia 'paginaSiguiente.html' por la URL deseada
});
...
document.getElementById('retry').addEventListener('click', () => {
    ...
    window.location.href = 'elefantes1.html'; // Reemplaza con la URL deseada
});
