document.addEventListener('DOMContentLoaded', () => {
    ...
    checkButton.addEventListener('click', () => {
        ...
        // Mostrar alerta emergente con el resultado
        if (isCorrect) {
            alert('¡Correcto! Has ordenado los payasos correctamente.');
        } else {
    ...
    nextButton.addEventListener('click', () => {
        ...
        window.location.href = 'pachacho1.html'; // Cambia 'siguiente.html' por la URL o ruta que desees
    });

    // Funcionalidad del botón "Reintentar"
    retryButton.addEventListener('click', () => {
        // Redirigir a la misma página para reintentar
        window.location.href = 'pachacho2.html'; // Cambia 'actual.html' por la URL o ruta que desees
    });
});