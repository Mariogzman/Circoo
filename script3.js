...
function checkAnswer() {
    if (selectedButton) {
        ...
        if (selectedVagon === correctAnswer) {
            alert("¡Correcto! Has seleccionado el vagon sin ningun alimento.");
        } else {
            alert("Incorrecto, en este vagon si hay alimentos.");
        }
    } else {
...
document.getElementById('retry').addEventListener('click', () => {
    window.location.href = 'juegotren3.html'; // Cambia 'paginaReintentar.html' por la URL deseada
});
